...
import com.practicaldime.router.core.servlet.HandlerPromise;
import com.practicaldime.router.core.servlet.HandlerRequest;
import com.practicaldime.router.core.servlet.HandlerResponse;
...
public class DemoApp {
    ...
    public static void main(String... args) {
        ...
        //$JAVA_HOME/bin/java -cp "target\zesty-router-0.1.1-shaded.jar;target\test-classes" com.practicaldime.router.core.demo.DemoApp --port 8090 --host localhost
