...
import com.practicaldime.router.core.server.AppOptions;
import com.practicaldime.router.core.server.Startable;
import com.practicaldime.router.core.servlet.RouteFilter;
import com.practicaldime.router.core.view.ViewEngine;
import com.practicaldime.router.core.view.ViewEngineFactory;
import com.practicaldime.router.http.session.SessionUtil;
...
public abstract class StartableImpl implements Startable {
    ...
    public final ViewEngine initEngine(ViewEngineFactory engineFactory) {
        ...
        switch (view) {
            ...
            case "freemarker":
                return engineFactory.engine(view, properties.apply("templates"), "com.practicaldime.router.view.ftl", "");
            case "handlebars":
            case "com.practicaldime.router.view.ejs":
            case "com.practicaldime.router.view.react":
                return engineFactory.engine(view, properties.apply("templates"), "template/js", properties.apply("lookup"));
            default:
