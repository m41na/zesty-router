...
import com.practicaldime.router.http.proxy.ProxyApp;
import com.practicaldime.router.http.proxy.ProxyConfig;
...
public class QuickStart {
    ...
    public static void main(String... args) throws Exception {
        ...
        //$JAVA_HOME/bin/java -cp target/zesty-router-0.1.1-shaded.jar com.practicaldime.router.core.app.QuickStart --config app.member0.json
